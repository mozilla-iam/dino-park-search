...
class App {
  ...
  async init(cfg) {
    ...
    this.app.get(
      this._base("/search/simple/:scope/"),
      handlers.createSimpleSearchQueryHandler()
    );
    this.app.get(
    ...
    this.app.get(
      this._base("/search/uuid/:userId"),
      handlers.createUuidByUserIdHandler()
    );
    this.app.post(
      this._base("/search/recreate"),
