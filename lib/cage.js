import { mapDoc } from "./mapping.js";
import { LEVELS, filterJsonObject } from "./filter.js";
...
class Cage {
  ...
  async getUuidByUserId(userId) {
    const dinoId = await this.storage.getByUserId(userId);
    return { uuid: dinoId };
  }
